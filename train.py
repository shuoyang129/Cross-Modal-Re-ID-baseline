...
parser.add_argument(
    "--model_path",
    default="/home/Monday/ys/results/sysu/save_model/",
    type=str,
...
parser.add_argument(
    "--log_path",
    default="/home/Monday/ys/results/sysu/log/",
    type=str,
    help="log save path",
)
parser.add_argument(
    "--vis_log_path",
    default="/home/Monday/ys/results/sysu/log/vis_log/",
    type=str,
    help="log save path",
)
parser.add_argument(
...
parser.add_argument(
    "--test-batch", default=64, type=int, metavar="tb", help="testing batch size"
)
parser.add_argument(
    "--method", default="agw", type=str, metavar="m", help="method type: base or agw"
)
parser.add_argument(
    "--margin", default=0.3, type=float, metavar="margin", help="triplet loss margin"
)
parser.add_argument(
    "--num_pos", default=4, type=int, help="num of pos per identity in each modality"
)
parser.add_argument(
...
if dataset == "sysu":
    data_path = "/home/Monday/datasets/SYSU/"
    log_path = args.log_path + "sysu_log/"
    test_mode = [1, 2]  # thermal to visible
elif dataset == "regdb":
    data_path = "/home/Monday/datasets/RegDB/"
...
queryset = TestData(
    query_img, query_label, transform=transform_test, img_size=(args.img_w, args.img_h)
)
...
def test(epoch):
    ...
    if dataset == "regdb":
        ...
        cmc, mAP, mINP = eval_sysu(
            -distmat, query_label, gall_label, query_cam, gall_cam
        )
